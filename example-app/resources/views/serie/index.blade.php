                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('serie.destroy',$serie->id) }}" method="POST">
                                                    <a class="btn btn-sm btn-primary " href="{{ route('serie.show',$serie->id) }}"><i class="fa fa-fw fa-eye"></i> {{ __('Show') }}</a>
                                                    <a class="btn btn-sm btn-success" href="{{ route('serie.edit',$serie->id) }}"><i class="fa fa-fw fa-edit"></i> {{ __('Edit') }}</a>
                                                    @csrf
                                                    @method('DELETE')
