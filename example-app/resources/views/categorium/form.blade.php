<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="form-group">
            ...
            {{ Form::text('Pelicula_id', $categorium->Pelicula_id, ['class' => 'form-control' . ($errors->has('Pelicula_id') ? ' is-invalid' : ''), 'placeholder' => 'Pelicula Id']) }}
            {!! $errors->first('Pelicula_id', '<div class="invalid-feedback">:message</div>') !!}
        </div>
        <div class="form-group">
            {{ Form::label('Serie_id') }}
            {{ Form::text('Serie_id', $categorium->Serie_id, ['class' => 'form-control' . ($errors->has('Serie_id') ? ' is-invalid' : ''), 'placeholder' => 'Serie Id']) }}
