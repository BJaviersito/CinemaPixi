                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('historial.destroy',$historial->id) }}" method="POST">
                                                    <a class="btn eye " href="{{ route('historial.show',$historial->id) }}"><i class="eye"></i> {{ __('') }}<svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-bookmark" viewBox="0 0 16 16">
                                                        <path d="M2 2a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v13.5a.5.5 0 0 1-.777.416L8 13.101l-5.223 2.815A.5.5 0 0 1 2 15.5zm2-1a1 1 0 0 0-1 1v12.566l4.723-2.482a.5.5 0 0 1 .554 0L13 14.566V2a1 1 0 0 0-1-1z"/>
                                                      </svg></a>
                                                    <a class="btn edit" href="{{ route('historial.edit',$historial->id) }}"><i class="edit"></i> {{ __('') }}<svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" fill="currentColor" class="bi bi-pen-fill" viewBox="0 0 16 16">
